import type { AnimationEventHandler, ClipboardEventHandler, CompositionEventHandler, DragEventHandler, EventHandler, FocusEventHandler, FormEventHandler, KeyboardEventHandler, MessageEventHandler, MouseEventHandler, PointerEventHandler, TouchEventHandler, TransitionEventHandler, UIEventHandler, WheelEventHandler } from "svelte/elements";
...
export type Microcomponent<T extends Prop> = 
